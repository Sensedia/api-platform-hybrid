...
```bash
sudo docker-compose -f NOMBRE_DIR/NOMBRE_ARCHIVO_COMPOSE ps
```

Sustituir el término ``NOMBRE_DIR`` por el directorio del servicio.

Sustituir el término ``NOMBRE_ARCHIVO_COMPOSE`` por el archivo del servicio.
