...
> Observação: Os pods de api-gateway não estarão disponíveis até que o próximo passo seja concluído ([Ativação de Ambiente Híbrido](#ativação-de-ambiente-híbrido)).
