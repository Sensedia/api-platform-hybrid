...
- [Instalação](README_pt.md#instalação)
  - [Usando Docker Compose](compose/README.md#api-platform-híbrido---docker-compose)
    ...
    - [Métodos de Deploy](compose/README.md#métodos-de-deploy)
      ...
      - [Deploy dos Serviços](compose/README.md#deploy-dos-serviços)
        - [Método all-in-one](compose/all-in-one/README.md#método-de-deploy-all-in-one)
  ...
  - [Usando Kubernetes](kubernetes/README.md#api-platform-híbrido---kubernetes)
    ...
    - [Recursos Recomendados](kubernetes/README.md#recursos-recomendados)
    - [Capacidade e Dimensionamento (RPS)](kubernetes/README.md#capacidade-e-dimensionamento-rps)
    - [Requisitos de Instalação](kubernetes/README.md#requisitos-de-instalação)
      ...
      - [Redis](kubernetes/README.md#redis)
        ...
        - [Escalabilidade e Elasticidade do Cluster Redis](kubernetes/README.md#escalabilidade-e-elasticidade-do-cluster-redis)
        - [Leitura a partir de Réplicas (Read Scaling)](kubernetes/README.md#leitura-a-partir-de-réplicas-read-scaling)
...
- [Installation](README_en.md#installation)
  ...
  - [Using Kubernetes](kubernetes/README_en.md#hybrid-api-platform---kubernetes)
    ...
    - [Supported Deployment Models](kubernetes/README_en.md#supported-deployment-models)
    - [Macro Topology](kubernetes/README_en.md#macro-topology)
    - [Recommended Resources](kubernetes/README_en.md#recommended-resources)
    - [Capacity and Sizing (RPS)](kubernetes/README_en.md#capacity-and-sizing-rps)
    - [Installation Requirements](kubernetes/README_en.md#installation-requirements)
      ...
      - [Redis](kubernetes/README_en.md#redis)
        ...
        - [Redis Cluster Scaling and Elasticity](kubernetes/README_en.md#redis-cluster-scaling-and-elasticity)
        - [Reading from Replicas (Read Scaling)](kubernetes/README_en.md#reading-from-replicas-read-scaling)
...
- [Instalación](README_es.md#instalación)
  ...
  - [Utilizando Kubernetes](kubernetes/README_es.md#api-platform-híbrido---kubernetes)
    ...
    - [Recursos Recomendados](kubernetes/README_es.md#recursos-recomendados)
    - [Capacidad y Dimensionamiento (RPS)](kubernetes/README_es.md#capacidad-y-dimensionamiento-rps)
    - [Requisitos de Instalación](kubernetes/README_es.md#requisitos-de-instalación)
      ...
      - [Redis](kubernetes/README_es.md#redis)
        ...
        - [Escalabilidad y Elasticidad del Clúster Redis](kubernetes/README_es.md#escalabilidad-y-elasticidad-del-clúster-redis)
        - [Lectura desde Réplicas (Read Scaling)](kubernetes/README_es.md#lectura-desde-réplicas-read-scaling)
